...
TextView titre, total_duration, curentTime;
BottomNavigationView bottomNavigationView;
Menu menu;
String[] ContenuCantique;
...
private SharedPref sharedPref;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                PartagerCantique(position+"-"+liste_titre_cantiques[position]+"\n \n"+ContenuCantique[position]);
            }
        });
    ...
    public void AgrandirTexte(MenuItem item) {
        if (nbre_zoom<=20) {
            ...
            title.setTextSize(size_texte_cantique+1);
